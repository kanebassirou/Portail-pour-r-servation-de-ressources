...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center py-2">
            <li class="breadcrumb-item"><a href="index.html" style="color: #007bff;">Réservation une video Projecter</a></li>
            <li class="breadcrumb-item active" aria-current="page" style="color: #6c757d;">reserver </li>
        </ol>
    </nav>
        <h1 class="fg-white text-center">creation votre réservation</h1>
...
@endif
  ...
  <div class="row justify-content-center mt-5">
    <div class="col-md-6">
        <form action="{{ route('reservationProjecteur.store', ['id' => $projecteur->id]) }}" method="POST">
            @csrf
            ...
            <input type="hidden" name="Projecteur_ID" value="{{ $projecteur->id }}">
