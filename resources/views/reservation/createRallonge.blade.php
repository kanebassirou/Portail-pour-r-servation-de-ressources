...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center py-2">
            <li class="breadcrumb-item"><a href="#index.html" style="color: #007bff;">Réservation une rallonge </a></li>
...
@section('content')
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">faite une reservation pour cette rallonge</div>
                <div class="col-md-6">
