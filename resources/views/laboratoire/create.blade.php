...
@section('title', 'ajouter laboratoire')
    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="py-2">
                ...
                <form action="{{ route('laboratoire.store') }}" method="POST" class="py-2">
                    @csrf
                    <div class="mb-4">
                        {{-- <label for="nom" class="block text-gray-700 text-sm font-bold mb-2">NomRessources :</label> --}}
                        <input type="hidden" name="nomRessource" id="nom" value="Laboratoire"
                           >
                    </div>
                    <div class="mb-4">
                        <label for="nomLaboratoire" class="block text-gray-700 text-sm font-bold mb-2">nom du Laboratoire
                            :</label>
                        <input type="text" name="nomLaboratoire" id="nomLaboratoire"
