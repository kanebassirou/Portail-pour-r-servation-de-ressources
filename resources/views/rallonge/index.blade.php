                    ...
                    @foreach ($rallonges as $rallonge)
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="confirmDeleteModal{{ $rallonge->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="confirmDeleteModalLabel{{ $rallonge->id }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('rallonge.destroy', $rallonge->id) }}"
