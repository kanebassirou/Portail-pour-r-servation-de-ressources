...
@if ($reservationRallonges->isEmpty())
    <p>Pas de réservations pour une rallonge .</p>
@else
    <div class="overflow-hidden shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900"> Une Rallonge</h3>
            <div class="mt-2 max-w-xl text-sm text-gray-500">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @foreach ($reservationRallonges as $reservation)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('admin.reservationRallonge.edit', $reservation->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('admin.reservationRallonge.destroy', $reservation->id) }}" method="POST"
