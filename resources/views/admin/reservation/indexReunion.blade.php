...
@section('content')
    ...
    @if ($reservationReunions->isEmpty())
        <p>Pas de réservations pour la salle de reunion.</p>
    @else
                ...
                <div class="mt-2 max-w-xl text-sm text-gray-500">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach ($reservationReunions as $reservation)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.reservationReunion.edit', $reservation->id) }}"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Êtes-vous sûr de vouloir supprimer cette reservation de salle de reunion  ?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                                style="color: black;">Annuler</button>
                                            <form action="{{ route('admin.reservationReunion.destroy', $reservation->id) }}" method="POST"
