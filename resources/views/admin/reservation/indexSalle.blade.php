    ...
    @else
        <div class="overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900"> Salle de classe</h3>
                            ...
                            @foreach ($reservationSalles as $reservation)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.reservationSalle.edit', $reservation->id) }}"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Êtes-vous sûr de vouloir supprimer cette reservation de salle de classe ?
                                        </div>
