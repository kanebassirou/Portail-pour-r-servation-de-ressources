...
@section('content')
    ...
    @if ($reservationCables->isEmpty())
        <p>Pas de réservations pour la salle de classe.</p>
    @else
        <div class="overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900"> Cable</h3>
                <div class="mt-2 max-w-xl text-sm text-gray-500">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach ($reservationCables as $reservation)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.reservationCable.edit', $reservation->id) }}"
                                            class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                        {{-- <form class="inline" action="{{ route('admin.reservationCable.destroy', $reservation->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('admin.reservationCable.destroy', $reservation->id) }}" method="POST"
