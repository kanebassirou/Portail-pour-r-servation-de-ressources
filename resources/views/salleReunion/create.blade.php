    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="py-2">
                ...
                <form action="{{ route('salleReunion.store') }}" method="POST" class="py-2">
                    @csrf
                    {{-- <div class="mb-4">
                        <label for="nom" class="block text-gray-700 text-sm font-bold mb-2">Nom de la salle de reunion:</label> --}}
                        <input type="hidden" name="nomRessource" id="nom" value="salle de reunion"
                           >
                    </div>
                    <div class="mb-4">
                        <label for="numero_salle" class="block text-gray-700 text-sm font-bold mb-2">Numero de salle
                            :</label>
                        <input type="number" name="numero_salle" id="numero_salle"
