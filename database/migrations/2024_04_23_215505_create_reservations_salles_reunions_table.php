...
return new class extends Migration
{
    ...
    {
        Schema::create('reservations_salles_reunions', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('SalleReunion_ID');
            $table->unsignedBigInteger('Utilisateur_ID');

            // Définition des contraintes de clé étrangère après avoir déclaré les colonnes
            $table->foreign('SalleReunion_ID')->references('id')->on('salle_reunions')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('reservations_salles_reunions');
    }
};
