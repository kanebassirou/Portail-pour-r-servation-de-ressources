...
return new class extends Migration
{
    ...
    {
        Schema::create('reservations_salles_classes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('SalleClasse_ID')->references('id')->on('salle_classes')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('reservations_salles_classes');
    }
};
